...
#	define TCC_VPU_2K_ENC_INCLUDE
#	define TCC_VPU_2K_JPU_INCLUDE
#endif
...
#define CMD_ENC_SEQ_264_VUI_PARA        (BIT_BASE + 0x19C)      // color aspect ratio info. of H.264 encoder (TELBB-547)
...
#define RET_ENC_PIC_INTRAMB_NUM         (BIT_BASE + 0x1E0)

#define RET_ENC_PIC_SUM_MB_QP           (BIT_BASE + 0x1F8)
...
#ifdef SUPPORT_MVC_ENC
#define CMD_SET_FRAME_SUBSAMP_A_MVC     (BIT_BASE + 0x1B0)
#define CMD_SET_FRAME_SUBSAMP_B_MVC     (BIT_BASE + 0x1B4)
#endif
...
#define CMD_ENC_SEQ_PARA_CABAC_MODE     (BIT_BASE + 0x1A0)	// entropy_coding_mode==2	// 20120924 V217
#define CMD_ENC_SEQ_PARA_PPS_ID         (BIT_BASE + 0x1B4)	// entropy_coding_mode==2	// 20120924 V217

#define RET_ENC_SEQ_PARA_CHANGE_SECCESS (BIT_BASE + 0x1C0)


#endif //TCC_VPU_2K_ENC_INCLUDE
...
#define CMD_DEC_SEQ_VC1_STREAM_FMT      (BIT_BASE + 0x19C)	// V2.1.8
...
#define RET_DEC_SEQ_MP2_BAR_LEFT_RIGHT  (BIT_BASE + 0x180)	// RefSW 2.1.13 20140228
#define RET_DEC_SEQ_MP2_BAR_TOP_BOTTOM  (BIT_BASE + 0x184)	// RefSW 2.1.13 20140228
#define RET_DEC_SEQ_VUI_INFO            (BIT_BASE + 0x18C)	// REFSW_313
#define RET_DEC_SEQ_DISPLAY_EXT         (BIT_BASE + 0x194)
#define RET_DEC_PIC_MP2_OFFSET1         (BIT_BASE + 0x19C)	// for MP2 - MP2PicDispExtInfo
#define RET_DEC_PIC_MP2_OFFSET2         (BIT_BASE + 0x1A0)	// for MP2 - MP2PicDispExtInfo
#define RET_DEC_PIC_MP2_OFFSET3         (BIT_BASE + 0x1A4)	// for MP2 - MP2PicDispExtInfo
#define RET_DEC_PIC_MP2_OFFSET_NUM      (BIT_BASE + 0x1A8)	// for MP2 - MP2PicDispExtInfo
#define RET_DEC_SEQ_VUI_PIC_STRUCT      (BIT_BASE + 0x1A8)	// REFSW_313
#define RET_DEC_SEQ_BIT_RATE            (BIT_BASE + 0x1B4)
#define RET_DEC_SEQ_EXT_INFO            (BIT_BASE + 0x1B8)	// 20120924 V217
...
#define CMD_DEC_PIC_NUM_ROWS            (BIT_BASE + 0x1B4)	// 20120924 V217
...
#define RET_DEC_PIC_MP2_TIME_CODE       (BIT_BASE + 0x194)	// for MP2 only
...
#define RET_DEC_PIC_VUI_PIC_STRUCT      (BIT_BASE + 0x1A8)	// REFSW_313
#define RET_DEC_PIC_POC_TOP             (BIT_BASE + 0x1AC)	// V2.1.9
#define RET_DEC_PIC_POC_BOT             (BIT_BASE + 0x1B0)	// V2.1.9
#define RET_DEC_PIC_POC                 (BIT_BASE + 0x1B0)	// V2.1.9
#define RET_DEC_NUM_MB_ROWS             (BIT_BASE + 0x1B4)	// it will be update	// 20120924 V217
#define RET_DEC_PIC_AVC_SEI_RP_INFO     (BIT_BASE + 0x1B4)
#define RET_DEC_PIC_HRD_INFO            (BIT_BASE + 0x1B8)	// 20120924 V217
...
#define	RET_DEC_PIC_MODULO_TIME_BASE    (BIT_BASE + 0x1E0)	// for MP4 V2.1.8
#define RET_DEC_PIC_VOP_TIME_INCREMENT  (BIT_BASE + 0x1E4)	// for MP4 V2.1.8
...
#define RET_DEC_PIC_SEQ_INFO            (BIT_BASE + 0x1FC)	// TELBB-383
...
#define RET_DEC_SEQ_CTYPE_INFO          (BIT_BASE + 0x1FC)
#define RET_DEC_PIC_CTYPE_INFO          (BIT_BASE + 0x1FC)
...
#define GDI_CFG_DATE                    (GDMA_BASE + 0x054)
#define GDI_HW_CFG_REV                  (GDMA_BASE + 0x058)
...
//------------------------------------------------------------------------------
#define DBG_CONFIG_REPORT_0             (GDMA_BASE + 0x040)	//product name and version : VPU_PRODUCT_NAME_REGISTER
#define DBG_CONFIG_REPORT_1             (GDMA_BASE + 0x044)	//interface configuration, hardware definition : VPU_PRODUCT_CODE_REGISTER
...
//------------------------------------------------------------------------------
#define RET_FW_VER_NUM                  (BIT_BASE + 0x1c0)	//RET_VER_NUM
